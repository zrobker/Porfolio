def main():    
    ...
    mass = float(input("Please enter the mass in grams: "))
    ...
    symbol_quantity_list = parse_formula(formula, p_table)
    
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    molar_mass = compute_molar_mass(symbol_quantity_list, p_table)
